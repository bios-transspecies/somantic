...
public class State {
    ...
    private static volatile float volume = 0f;
    private static volatile String libraryFile = "library.affect";
    private static volatile String message = "";
    private static volatile String sentences = "";
    private static volatile AtomicBoolean isVisualising = new AtomicBoolean(false);
    private static volatile float[] affectsArray = null;
    private static volatile String login;
    private static volatile String password;
    private static volatile String bufferedText;
    private static volatile AtomicBoolean visualisation = new AtomicBoolean(false);
    private static volatile SomanticFacade somanticFacade = SomanticFacade.getInstance();
    private static volatile JProgressBar jProgressBar;
    private static volatile Long minimalSimilarity = 0L;
    private static volatile Set<SomanticWord> sentence = new ConcurrentSkipListSet<>();
    private static volatile AtomicBoolean saving = new AtomicBoolean(false);
    private static volatile String literatureLocation;
    private static volatile NeuralNetworkTrainer neuralNetworkTrainer = new NeuralNetworkTrainer();
    private static volatile Controller subscriber;
    private static volatile JLabel nnStateLabel;
    private static volatile AtomicBoolean liveactIsOn = new AtomicBoolean(false);
    private static volatile SomanticWord word = new SomanticWord("");
